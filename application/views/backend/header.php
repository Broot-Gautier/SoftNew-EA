    ...
    <div class="container-fluid">
        ...
        <div id="header-menu" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php $active = ($active_menu == PRIV_USERS_OTHERS) ? 'active' : '' ?>
                <li class="<?= $active . $hidden ?>">
                    <a href="<?= site_url('backend/otherUsers') ?>" class="menu-item"
                            title="<?= lang('others_hint') ?>">
                        <?= lang('others') ?>
                    </a>
                </li>
                ...
                <?php $active = ($active_menu == PRIV_USERS_PROFILE) ? 'active' : '' ?>
                <li class="<?= $active ?>">
                    <a href="<?= site_url('backend/profile') ?>" class="menu-item"
                            title="<?= lang('profile_hint') ?>">
                        <?= lang('profile') ?>
                    </a>
                </li>

                <?php 
                    if($user_settings['id_roles'] == 1)
                    {
                        $active = TRUE;
                    }else{
                        $active = FALSE; 
