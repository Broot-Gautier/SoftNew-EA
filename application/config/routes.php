...
// borre welcome por default. hacer una ruta especifica
...
$route['profile_controller'] = 'profile';
$route['ajaxupload_controller']['post'] = "ajaximageupload";
//$route['backend_controller'] = 'backend';
/* End of file routes.php */
/* Location: ./application/config/routes.php */
$route['send_email'] = "emails";
$route['welcome/signup'] = "welcome/signup";